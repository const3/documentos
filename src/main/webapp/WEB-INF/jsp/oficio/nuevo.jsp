...
<html>
    ...
    <body class="span12">
        ...
        <form:form action="${nuevo}" method="post" commandName="oficio">
            <form:errors path="*">
            ...
            <fieldset>
                <div class="row-fluid">
                    ...
                    <s:bind path="oficio.departamento">
                    ...
                    <s:bind path="oficio.destinatario">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                ...
                <p class="well" style="margin-top: 10px;">
                    ...
                    <a class="btn " href="<s:url value='/oficio'/>"><i class="icon-remove"></i> Cancelar </a>
                </p>
            </fieldset>
        </form:form>
