...
<html>
    ...
    <body class="span12">
        ...
        <form:form action="${nuevo}" method="post" commandName="memoInter">
            <form:errors path="*">
            ...
            <fieldset>
                <div class="row-fluid">
                    ...
                    <s:bind path="memoInter.departamento">
                    ...
                    <s:bind path="memoInter.remitente">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                                <label for="remitente">
                    ...
                    <s:bind path="memoInter.contenido">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                                <label for="contenido">
