...
<html>
    ...
    <body class="span12">
        ...
        <c:url var="nuevo" value="/circular/crea"/>
        <form:form action="${nuevo}" method="post" commandName="circular">
            <form:errors path="*">
            ...
            <fieldset>
                <div class="row-fluid">
                    ...
                    <s:bind path="circular.departamento">
                    ...
                    <s:bind path="circular.destinatario">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                    ...
                    <s:bind path="circular.remitente">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                                <label for="remitente">
                    ...
                    <s:bind path="circular.contenido">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                                <label for="contenido">
